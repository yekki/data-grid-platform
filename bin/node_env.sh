...
#DGP_NODE_MEM_ARGS="-Xms1024m -Xmx1024m -XX:+DisableExplicitGC -XX:+HeapDumpOnOutOfMemoryError -verbosegc -XX:+PrintGCDateStamps -XX:+PrintGCDetails -XX:+PrintHeapAtGC -Xloggc:$DGP_HOME/nodes/logs/$DGP_NODE_NAME_gc.log -XX:HeapDumpPath=$DGP_HOME/nodes/logs"
DGP_NODE_MEM_ARGS=
